...
* Eclipse Collections
** link:A1_mystory_decadeone.adoc[First decade] -- Development by a single Financial Services Firm
*** Free as in "beer" - link:https://github.com/goldmansachs/gs-collections[GS Collections]
*** 4 Committers
*** ~15 Contributors
*** ~20K downloads per month
** link:A2_mystory_decadetwo.adoc[Second Decade] -- Development and advocacy at the Eclipse Foundation
